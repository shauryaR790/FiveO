...
export function IconClockOutline({ size = 28 }: { size?: number }) {
  return (
...
export function IconGlobeOutline({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} fill="none" viewBox="0 0 24 24" aria-hidden>
      <circle cx="12" cy="12" r="9" stroke="white" strokeWidth="1.5" />
      <path
        d="M3 12h18M12 3a17 17 0 014 18M12 3a17 17 0 01-4 18"
        stroke="white"
        strokeWidth="1.5"
      />
    </svg>
...
export function CapabilityIconImage() {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
...
export function CapabilityIconMovie() {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
...
export function CapabilityIconLightbulb() {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 24 24"
